...
from experiments.sokoban.sokoban_terminations import *
import numpy as np
...
if __name__ == "__main__":
    ...
    experiment = DivDisMetaExperiment(base_dir=args.base_dir,
                                      ...
                                      action_policy=create_cnn_policy(3,3),
                                    #   action_policy=create_cnn_policy(3,13),
                                      action_vf=create_cnn_vf(3),
                                      terminations=terminations,
                                      option_type="mock")

    env = environment_builder(level_name="PushAndPull-Sokoban-v0", seed=args.seed)
