...
div_df = get_df_from_csv('div', "D-BAT")
nodiv_df = get_df_from_csv('nodiv', "Standard")
onehead_df = get_df_from_csv('onehead', "CNN")
perfect_df = get_df_from_csv('perfect', "Perfect")

mega_df = pd.concat([dqn_df, ppo_df, div_df,
                     nodiv_df, onehead_df, perfect_df])
...
plot = sns.lineplot(data=mega_df, x="Step", y="rolling_success", 
                    hue="exp", style="exp", err_style='band', 
                    errorbar='se')
