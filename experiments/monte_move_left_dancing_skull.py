...
initiation_positive_files = [
    'resources/monte_images/dancing_skulls_1_initiation_positive.npy',
    'resources/monte_images/dancing_skulls_2_initiation_positive.npy'
]
initiation_negative_files = [
    'resources/monte_images/dancing_skulls_1_initiation_negative.npy',
    'resources/monte_images/dancing_skulls_2_initiation_negative.npy',
...
termination_positive_files = [
    'resources/monte_images/dancing_skulls_1_termination_positive.npy',
    'resources/monte_images/dancing_skulls_2_termination_positive.npy'
]
termination_negative_files = [
    'resources/monte_images/dancing_skulls_1_termination_negative.npy',
    'resources/monte_images/dancing_skulls_2_termination_negative.npy',
