...
from portable.option.option_utils import get_player_position, get_object_position, get_player_room_number
...
class MonteSpiderGoalWrapper(MonteObjectGoalWrapper):
    ...
    def step(self, action):
        ...
        reward, done = self.finished_skill(player_x, player_y, spider_x, room, done, info)
