...
class Clip(nn.Module):
    ...
    def forward(self, images):
        ...
        with torch.no_grad():
            vision_outputs = self.clip_model(pixel_values=inputs['pixel_values'], return_dict = False)
        ...
        embeddings = torch.tensor(vision_outputs.pooler_output, device=images.device)
