...
class MinigridOption():
    ...
    def can_initiate(self, state, markov_space_state):
    ...
    def run(self, 
        ...
        global_vote, markov_vote = self.can_initiate(agent_state, latent_state)
