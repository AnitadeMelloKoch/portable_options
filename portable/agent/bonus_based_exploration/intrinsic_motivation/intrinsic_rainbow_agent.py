...
@gin.configurable
class PixelCNNRainbowAgent(base_rainbow_agent.RainbowAgent, intrinsic_dqn_agent.PixelCNNDQNAgent):
    ...
    def step(self, reward, observation):
        return intrinsic_dqn_agent.PixelCNNDQNAgent.step(self, reward, observation)

@gin.configurable
class RNDRainbowAgent(base_rainbow_agent.RainbowAgent, intrinsic_dqn_agent.RNDDQNAgent):
    ...
    """
        ...
        super(RNDRainbowAgent, self).__init__(sess=sess,
                                              num_actions=num_actions,
                                              num_atoms=num_atoms,
                                              vmax=vmax,
                                              gamma=gamma,
